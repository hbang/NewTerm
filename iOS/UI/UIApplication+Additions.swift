...
extension UIApplication {
	...
	func activateScene(userActivity: NSUserActivity, requestedByScene requestingScene: UIScene? = nil, asSingleton: Bool = true, withProminentPresentation prominentPresentation: Bool = false) {
